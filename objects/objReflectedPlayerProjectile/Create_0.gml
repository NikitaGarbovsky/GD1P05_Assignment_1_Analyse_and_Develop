...
// Randomly chooses a value between 1 and 5,
...
switch (number)
{
	case 1 :
	{
		Process_Shot(DownwardDirection1);
		break;
	}
	case 2 :
	{
		Process_Shot(DownwardDirection2);
		break;
	}
	case 3 :
	{
		Process_Shot(DownwardDirection3);
		break;
	}
	case 4 :
	{
		Process_Shot(DownwardDirection4);
		break;
	}
	case 5 :
	{
		Process_Shot(DownwardDirection5);
		break;
	}
}
